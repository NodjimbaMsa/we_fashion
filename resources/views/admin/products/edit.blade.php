                    ...
                    <div class="panel-body">
                        ...
                        <form enctype="multipart/form-data" action="{{route('products.update', $product)}}" method="POST" class="my-8">
                            ...
                            <div class="form-group my-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{{ old('reference', $product->reference) }}" name="reference" id="reference" placeholder="Inscrivez un réference">
                                </div>
                            </div>
                            ...
                            <div class="form-group my-3">
                                ...
                                <div class="col-sm-9">
                                    <label class="radio-inline">
                                        <input type="radio" name="visibility" id="visiblity" value="published" {{(old('visiblity') == 'published') || $product->visiblity == 'published' ? 'checked' : ''}}>Publié
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="visibility" id="visbility" value="no_published" {{(old('visiblity') == 'no_published') || $product->visiblity == 'no_published' ? 'checked' : ''}}>Non Publié
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-primary mb-3">Mettre à jours ce produit</button>
                            </div>
